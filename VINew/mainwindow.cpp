...
//		qDebug() << "Probe Observer Notification:"<<m_objVISubject->getProbeDialog(0);
		...
		{
			ui->lblProbeComparison_2->setText("Envelope");
		}
...
//			qDebug()<<"SINGLE";
			...
			m_nStoreWaveIndex=1;
			ui->butExternal->setDisabled(false);
...
//			qDebug()<<"DUAL";
			...
			ui->butExternal->setDisabled(true);
...
//		qDebug()<<"Probe Dialog Status:"<<m_objVISubject->getProbeDialog(0);
        ...
        if(m_objVISubject->getProbeDialog(0) ==0)
        {
                ...
                {
                        if(/*IPTMessageBox->QMsgBox*/showMessageBox(true, true, "Ensure External Mux Cable is connected or Not.")==true)
                                return true;
                        else
...
//                    qDebug()<<"Toggle Index:"<<m_nToggleIndex;
            ...
            //IGPIOEvent->BlockSig(true);
            if (pKeyCode == 0x0c || pKeyCode == 0x90) {
            ...
            } else if (pKeyCode == 0x09 || pKeyCode == 0xc0) {
...
void MainWindow::on_butProbe1_clicked()
{
	...
	ui->butExternal->setStyleSheet(knobOFF);
