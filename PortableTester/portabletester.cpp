...
//		if(i<FUNCTIONS){
//			FunctionalButton[i] = new QmaxPushButton(i, this);
//			FunctionalButton[i]->setGeometry(720, 70 + (i * 100), 70, 70);
//			FunctionalButton[i]->setIcon(QIcon(QPixmap(icon	+ QString::number(i, 10) + ".png")));
//
...
//
//			connect(FunctionalButton[i],SIGNAL(CClicked(int)),this,SLOT(buttonPressed(int)));
//			FunctionalButton[i]->setVisible(false);
//
//		}
	}
...
//	testjigButton = new QmaxPushButton(16, this);
//	testjigButton->setGeometry(200, 500, 70, 70);
//	testjigButton->setIcon(QIcon(QPixmap(":/Desktop/Testjig.png")));
//	connect(testjigButton,SIGNAL(CClicked(int)),this,SLOT(buttonPressed(int)));

//	prevButton =new QmaxPushButton(17,this);
//	prevButton->setGeometry(730,40,50,25);
//	prevButton->setIcon(QIcon(QPixmap(":/Desktop/arrow-up.png")));
//	prevButton->setIconSize(QSize(24,24));
//	connect(prevButton,SIGNAL(CClicked(int)),this,SLOT(buttonPressed(int)));

//	nextButton =new QmaxPushButton(18,this);
//	nextButton->setGeometry(730,540,50,25);
//	nextButton->setIcon(QIcon(QPixmap(":/Desktop/arrow-down.png")));
//	nextButton->setIconSize(QSize(24,24));
//	connect(nextButton,SIGNAL(CClicked(int)),this,SLOT(buttonPressed(int)));
...
//	l_objMainView->InitBasePane();
	...
	baseFrame->setStyleSheet("QFrame{image: url(:/gradient_oval1.png);}");
	...
	splashIdle->setPixmap(QPixmap(":/imageIdle.png").scaled(790, 590));
	splashIdle->setEnabled(false);
}
void PortableTester::on_shutDownButton_clicked() {
	...
	if (ret == 'Y') {
		...
		splash->setPixmap(QPixmap(":/Symbols/image93.png").scaled(790, 590));
		splash->show();
...
void PortableTester::paintEvent(QPaintEvent *pEvent) {
	...
	pPainter->drawPixmap(rect(), QPixmap(":/Symbols/PTFront.png"));
	delete pPainter;

	QStylePainter painter(this);
	QColor l_objColor;
	painter.drawPixmap(0, 0, QPixmap(":/Symbols/PTFront.png"));
	if (hasFocus()) {
