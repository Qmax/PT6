		...
		if(autoFlag==true){
			do{
				...
				if((m_nRange==30 && m_nResistance>30)){
					qDebug()<<"30E Break";
					break;
				}else if((m_nRange==300 && m_nResistance<0)||(m_nRange==300 && m_nResistance>1100)){
					qDebug()<<"300E Break";
					break;
				}else if((m_nRange==3000 && m_nResistance<200)||(m_nRange==3000 && m_nResistance>4000)){
					qDebug()<<"3KE Break";
					break;
				}else if((m_nRange==30000 && m_nResistance<300)||(m_nRange==30000 && m_nResistance>25000)){
					qDebug()<<"30KE Break";
					break;
				}else if((m_nRange==300000 && m_nResistance<20000)||(m_nRange==300000 && m_nResistance>400000)){
					qDebug()<<"300KE Break";
					break;
