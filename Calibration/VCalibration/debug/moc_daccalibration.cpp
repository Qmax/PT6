...
**
** Created: Wed Sep 25 17:00:36 2013
...
static const char qt_meta_stringdata_DACCalibration[] = {
    ...
    "on_CalibratedRef_clicked(bool)\0"
...
int DACCalibration::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_CalibratedRef_clicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: on_Calibrated_clicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: on_driveBut_2_clicked(); break;
        case 3: on_comboBox_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: on_nextBut_clicked(); break;
        case 5: on_driveBut_clicked(); break;
        case 6: on_saveBut_clicked(); break;
        case 7: on_exitBut_clicked(); break;
        case 8: callNoOfPointsEdit(); break;
        case 9: callDriveVoltageEdit(); break;
        case 10: callRxedVoltageEdit(); break;
        case 11: callTestVoltageEdit(); break;
