    ...
    : QWidget(parent)
{
	ui.setupUi(this);
        ...
        animation->setEndValue(QRect(120, 100, 598, 135));
...
void PTPSoCTestJigInterface::Initialization(){
	...
	AppAddr = ILineEdit->QmaxLineEdit(3,ui.groupBox);
	AppAddr->setGeometry(ui.leAppAddr->geometry());

	AppData = ILineEdit->QmaxLineEdit(3,ui.groupBox);
	AppData->setGeometry(ui.leAppData->geometry());

	BckAddr = ILineEdit->QmaxLineEdit(3,ui.groupBox_2);
	BckAddr->setGeometry(ui.leBckAddr->geometry());

	BckData = ILineEdit->QmaxLineEdit(3,ui.groupBox_2);
...
void PTPSoCTestJigInterface::enableRichGUI(){
	...
	ui.pushButton_5->setGeometry(540,20,50,90);
